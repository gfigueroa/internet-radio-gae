...
<h1>Delete Group Member Test</h1>

<form method="post" id="form1" name="form1"
		action="/cloudSync?action=deleteGroupMember"
		class="form-style">
	...
	<input type="text" name="g_key" value="ahlzbWFzcnYtY29zLXRlc3RpbmctYmFja3VwcjELEghDdXN0b21lciITY3VzdG9tZXJAc21hc3J2LmNvbQwLEglVc2VyR3JvdXAYvgEM" style="display:none;" />
	<input type="text" name="m_email" value="customer2@smasrv.com" style="display:none;" />
