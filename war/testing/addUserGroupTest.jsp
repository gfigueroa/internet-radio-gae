...
<h1>Add User Group	 Test</h1>

<form method="post" id="form1" name="form1"
		action="/cloudSync?action=addUserGroup"
		class="form-style">
	...
	<input type="text" name="g_name" value="Test Group" style="display:none;" />
	<input type="text" name="g_description" value="Test group description" style="display:none;" />
