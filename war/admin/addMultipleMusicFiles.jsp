...
<form method="post" id="form1" name="form1" 
	...
	<div>
	  <h2><%= printer.print("Add Multiple Music Files") %></h2>
	</div>
	...
	<div>
       	<label for="file"><span><%= printer.print("File(s)") %></span></label>
		<input type="file" name="file" class="input_extra_large" value="" multiple /><br />
		<div id="file"></div>
	</div>
