...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list-table">
  ...
  <tr>
    <td width="20%">
    <a href="/admin/addMusicFile.jsp">+ <%= printer.print("Add New Music File") %></a>
    <br/>
    <a href="/admin/addMultipleMusicFiles.jsp">+ <%= printer.print("Add Multiple Music Files") %></a>
    </td>
    <td width="10%"></td>
    <td width="10%"></td>
    <td width="40%"></td>
...
%>
  <tr>
    <td width="20%"><a href="/admin/editMusicFile.jsp?k=<%= musicFile.getKey() %>"><%= musicFile.getMusicFileTitle() %></a></td>
    ...
    <td width="20%">
    <a href="javascript:void(0);" onclick="confirmDelete('/manageObject?action=delete&type=M&k=<%= musicFile.getKey() %>', '<%= printer.print("Are you sure you want to delete this Music File")%>');"><%= printer.print("Delete") %></a>
  	</td>
  </tr>
<%  
  }
